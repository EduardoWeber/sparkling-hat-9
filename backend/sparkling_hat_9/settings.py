"""
Django settings for sparkling_hat_9 project.
...
ROOT_URLCONF = 'sparkling_hat_9.urls'
...
WSGI_APPLICATION = 'sparkling_hat_9.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sparkling_hat_9 API",
    "DESCRIPTION": "API documentation for sparkling_hat_9 App",
    "VERSION": "v1",
}
